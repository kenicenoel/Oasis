...
?>
	<Doctype html>
	 <html>
		...
		<span id="sticky">
			<p class = "menu"><i class="icon-list on-left"></i> Menu</p>
			...
			<a class ="link" href ="#" title = "Change things like your name, theme color and contact info"><i class="icon-address-book on-left"></i> Account</a>
			<a class ="link" href ="#" title = "Listings you like are managed here"><i class="icon-heart on-left"></i> Favourites</a>
			<a class ="link" href ="system.php" title = "Look for more listings"><i class="icon-search on-left"></i> New search</a>
